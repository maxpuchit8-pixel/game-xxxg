  ...
  root.EventTemplates = (root.EventTemplates || []).concat([
       ...
       ทางเลือกสุดท้ายอาจตั้งครรภ์กับคนแปลกหน้าที่ไม่มีวันปรากฏในผังตระกูล */
    {
      ...
      options: [
        ...
        { label: 'เรียกทั้ง {count} คนเข้ามาพร้อมกัน', value: 'all', note: 'ระบายจนหมดหลอด · หากตั้งครรภ์จะไม่มีใครรู้ว่าใครเป็นบิดา · ชื่อเสียง -4',
          effect: { desire: -120, child: 'stranger', rep: -4,
            trait: 'radiantOne', traitStory: 'ตัดสินใจครั้งนั้นด้วยตนเองโดยไม่ลังเลแม้ชั่วอึดใจ',
            tally: { key: 'bait', trait: 'temptress', need: 2,
              story: 'เป็นผู้กำหนดทุกอย่างในค่ำคืนที่ผู้อื่นได้แต่รอคำสั่ง' },
            text: 'ประตู{place}ปิดลงพร้อมกับ{strangers} — เช้าวันรุ่งขึ้น{name}เดินออกมาเพียงผู้เดียวอย่างสงบ' } },
