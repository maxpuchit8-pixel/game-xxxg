...
(function (root) {
   ...
   * ตั้งให้ต่ำพอที่ผังทั้งตระกูลจะลงจอมือถือได้ เพราะการเห็นโครงทั้งหมดก่อน
   * แล้วค่อยบีบนิ้วซูมเข้าไปอ่าน ใช้งานง่ายกว่าการเปิดมาแล้วเห็นแค่บางส่วน
   * โดยไม่รู้ว่าตระกูลแตกกิ่งไปทางไหนบ้าง */
